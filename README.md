...
Similar deductions can be made when analyzing weekly fare data occuring between the months of January-April 2019. Some new inferences can alse be made with this analysis (see image below):
...
A second area in the data to consider is the comparative difference in total rides and drivers in rural areas  vs. the comparative difference in total fare in rural areas - that is, the relative number of total rides and drivers in rural city types is significantly lower than total fares in these areas. Here, another opportunity to extend profits may exist: money is being spent in these areas, however, the frequency of rides is low and the number of drivers is even lower (comparative to suburban and urban areas). Although susceptible to other factors, given the data, a variable behind the low frequency of rides in rural cities could be due to lack of presence and accessibility - turning focus to building a larger driver base in rural areas could very well lead to greater accessibility and greater frequency of rides. Given the above results - i.e that rural areas see a relatively high average fare/ride and good total fare value given the extreme lack of drivers and total rides - this change could make a meaningful impact on profits in rural areas. This, of course, involves some speculation, however is an area worth investigating nevertheless.

Finally, given the very similar trends seen across all city types through the first four months of the year regarding their total fares, one could be confident that changes made regarding fares (including those suggested above) could be generalized over longer periods of time in the year across city types. One could inference that these changes could potentially be generalized over the course over the entirety of the year rather than looking for seasonal changes in services across different city types, providing less strain for the business overall. 
